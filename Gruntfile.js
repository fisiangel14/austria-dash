// Generated on 2016-06-12 using generator-angular-fullstack 3.7.5
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      test: {
        src: ['<%= yeoman.client %>/{app,components}/**/*.{mock}.js']
      }
    },
    ...
    clean: {
      ...
      distsmall: {
        files: [{
          ...
          src: [
            '.tmp',
            '<%= yeoman.distsmall %>/!(.git*|.openshift|Procfile)**'
          ]
        }]
      },      
      server: '.tmp'
