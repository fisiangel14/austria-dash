...
//				endControlLinkMode(riskNode);
      ...
      subRisk.FIXED = 'Y';
      subRisk.FIXED_COVERAGE = subRisk.COVERAGE;
      ...
      //set all sub-risks to 0 
        ...
        // // new
        // if (!isNaN(sr.RN_SUB_RISK_ID)) {
        //   Coverage.getRiskNodeSubRiskCoverage(sr.RN_SUB_RISK_ID)
        //   .then(function(data){
        //     console.log(sr.RN_SUB_RISK_ID, ":", data.COVERAGE);
        //     sr.COVERAGE = data.COVERAGE;
        //   });
        // }
        // // new
