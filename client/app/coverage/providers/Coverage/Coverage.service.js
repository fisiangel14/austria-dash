...
function CoverageService($rootScope, Entry, $http, $q, $uibModal, $timeout) {
  ...
  // Public API here
    return {
      ...
      getProductSegmentsForControlClone: function(opcoId, riskId, systemId){
        return $http({
          url: '/api/coverage/getProductSegmentsForControlClone', 
          method: 'GET',
          params: {opcoId: opcoId, riskId:riskId, systemId:systemId}
        })
        .then(function(response) {
            return response.data;
          }, function(response) {
      ...
      getProductSegmentsHistory: function(opcoId, forDate){
        return $http({
          url: '/api/coverage/getProductSegmentsHistory', 
          method: 'GET',
          params: {opcoId: opcoId, forDate: forDate}
        })
        .then(function(response) {
            return response.data;
          }, function(response) {
      ...
      getRiskNodeSubRiskCoverage: function(rnSubRiskId){
        return $http({
          url: '/api/coverage/getRiskNodeSubRiskCoverage', 
          method: 'GET',
